...
#define PROTO_1_16_2 0x00011602
...
#define SP_SpawnMob             SP(02)
#define SP_SpawnPainting        SP(03)
#define SP_SpawnPlayer          SP(04)
#define SP_Animation            SP(05)
#define SP_Statistics           SP(06)
#define SP_AckPlayerDigging     SP(07) // new
...
#define SP_WindowItems          SP(13)
#define SP_WindowProperty       SP(14)
#define SP_SetSlot              SP(15)
#define SP_SetCooldown          SP(16)
#define SP_PluginMessage        SP(17)
#define SP_NamedSoundEffect     SP(18)
#define SP_Disconnect           SP(19)
#define SP_EntityStatus         SP(1a)
#define SP_Explosion            SP(1b)
#define SP_UnloadChunk          SP(1c)
...
#define SP_UpdateLight          SP(23) // new
#define SP_JoinGame             SP(24)
#define SP_Map                  SP(25)
...
#define SP_FacePlayer           SP(33)
#define SP_PlayerPositionLook   SP(34)
#define SP_UnlockRecipes        SP(35)
#define SP_DestroyEntities      SP(36)
#define SP_RemoveEntityEffect   SP(37)
#define SP_ResourcePackSent     SP(38)
#define SP_Respawn              SP(39)
#define SP_EntityHeadLook       SP(3a)
#define SP_MultiBlockChange     SP(3b)
#define SP_SelectAdvancementTab SP(3c)
...
#define SP_DisplayScoreboard    SP(43)
#define SP_EntityMetadata       SP(44)
#define SP_AttachEntity         SP(45)
#define SP_EntityVelocity       SP(46)
#define SP_EntityEquipment      SP(47)
#define SP_SetExperience        SP(48)
#define SP_UpdateHealth         SP(49)
#define SP_ScoreboardObjective  SP(4a)
#define SP_SetPassengers        SP(4b)
#define SP_Teams                SP(4c)
...
#define SP_EntityProperties     SP(58)
#define SP_EntityEffect         SP(59)
#define SP_DeclareRecipes       SP(5a)
#define SP_Tags                 SP(5b)
#define SP_UpdateSign           SP(80) // removed since 1.9.4
#define SP_UseBed               SP(81) // removed
#define SP_SpawnGlobalEntity    SP(82) // removed
#define SP___                   SP(ff)

#define CP_TeleportConfirm      CP(00)
#define CP_QueryBlockNbt        CP(01)
#define CP_SetDifficulty        CP(02) // new but appears to be singleplayer only
#define CP_ChatMessage          CP(03)
#define CP_ClientStatus         CP(04)
#define CP_ClientSettings       CP(05)
#define CP_TabComplete          CP(06)
#define CP_ConfirmTransaction   CP(07)
#define CP_EnchantItem          CP(08) // TODO: Now Called Click Window Button
#define CP_ClickWindow          CP(09)
#define CP_CloseWindow          CP(0a)
#define CP_PluginMessage        CP(0b)
#define CP_EditBook             CP(0c)
#define CP_QueryEntityNbt       CP(0d)
#define CP_UseEntity            CP(0e)
#define CP_GenerateStructure    CP(0f) // new
#define CP_KeepAlive            CP(10)
#define CP_LockDifficulty       CP(11)
#define CP_PlayerPosition       CP(12)
#define CP_PlayerPositionLook   CP(13)
#define CP_PlayerLook           CP(14)
#define CP_Player               CP(15)
#define CP_VehicleMove          CP(16)
#define CP_SteerBoat            CP(17)
#define CP_PickItem             CP(18)
#define CP_CraftRecipeRequest   CP(19)
#define CP_PlayerAbilities      CP(1a)
#define CP_PlayerDigging        CP(1b)
#define CP_EntityAction         CP(1c)
#define CP_SteerVehicle         CP(1d)
#define CP_SetDisplayedRecipe   CP(1e) // new
#define CP_SetRecipeBookState   CP(1f) // new
#define CP_NameItem             CP(20)
#define CP_ResourcePackStatus   CP(21)
#define CP_AdvancementTab       CP(22)
#define CP_SelectTrade          CP(23)
#define CP_SetBeaconEffect      CP(24)
#define CP_HeldItemChange       CP(25)
#define CP_UpdateCommandBlock   CP(26)
#define CP_UpdateCmdMinecart    CP(27)
#define CP_CreativeInventoryAct CP(28)
#define CP_UpdateJigsawBlock    CP(29) // new
#define CP_UpdateStructureBlock CP(2a)
#define CP_UpdateSign           CP(2b)
#define CP_Animation            CP(2c)
#define CP_Spectate             CP(2d)
#define CP_PlayerBlockPlacement CP(2e)
#define CP_UseItem              CP(2f)
#define CP_PrepareCraftingGrid  CP(80) // removed since 1.12.1
#define CP_RecipeBookData       CP(81) // removed and replaced with 2 other packets
#define CP___                   CP(ff)
