...
const static packet_methods SUPPORT_1_16_2[2][MAXPACKETTYPES] = {
    {
        ...
        SUPPORT_DEDF(0x22,SP_ChunkData,_1_9_4),
        SUPPORT_DD  (0x23,SP_Effect,_1_8_1),
        ...
        SUPPORT_DD  (0x29,SP_EntityLookRelMove,_1_9),
    ...
    },
    {
        ...
        SUPPORT_DED (0x18,CP_PlayerDigging,_1_9),
        SUPPORT_DED (0x19,CP_EntityAction,_1_8_1),
